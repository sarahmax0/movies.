const data = {
    ...
    "total_pages": 39372,
    "total_results": 787427
  }


  //https://api.themoviedb.org/3/account/{account_id} (puxar informações do filme)
  async function getMoreInfo(id) {
    const options = {
        method: 'GET',
        headers: {
          accept: 'application/json',
          Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJiMWM4NTg0ODFmOWQyNWVlZGJjNDUxYjY2MjU0OTViNyIsInN1YiI6IjY0Y2FhYjAyOWVlMGVmMDBhZWU0NDlkZiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.PdVu7Xrf0ylXuoAeFxuzO0uAydRwxKUO8o6cs-tRGKw'
        }
      };
  ...
  //https://api.themoviedb.org/3/movie/{movie_id}/videos (quando clicar no botão de assistir trailer)
  async function watch(e) {
    const options = {
      ...
      try {
        const data = await fetch(`https://api.themoviedb.org/3/movie/${e.currentTarget.dataset.id}/videos`, options)
        .then(response => response.json())
  ...
  async function start() {
    //pegas as sugestões de filmes da api
